---
description: Engage in a prolonged, focused discussion without pressure to implement or move on.
---

1.  **Mode Switch**: Enter a "Listening and Analyzing" mode.
2.  **No Unprompted Action**: Do NOT propose code changes, file creations, or terminal commands unless the user explicitly asks for them *in this turn*.
